;; -*- mode: emacs-lisp -*-
;; This 0x800071loaded by Spacemacs at startup.
...
values."
  ;; This setq-default sexp is an exahustive list of all the supported
  ;; spacemacs settings.
  (setq-default
